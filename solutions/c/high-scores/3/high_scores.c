...
/**
 * `compare` is a helper function that doesn't need to be accessible to the outside world,
 * so it has been moved from the header file and declare as `static` to help hide it.
 */
